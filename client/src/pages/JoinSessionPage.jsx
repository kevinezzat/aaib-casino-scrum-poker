          ...
          <>
            ...
            <form onSubmit={handleJoin} className="flex flex-col gap-md relative z-10">
              ...
              <div className="flex flex-col gap-xs">
                ...
                <div className="grid grid-cols-2 gap-xs">
                  ...
                  <button
                    ...
                    className={`relative flex flex-col items-center gap-xs p-sm rounded-xl border-2 transition-all duration-200 group ${
                      selectedRole === 'voter'
              ...
              <button
                ...
                className={`w-full font-label-md py-sm rounded-lg uppercase tracking-wider transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-xs mt-sm ${
                  selectedRole === 'spectator'
